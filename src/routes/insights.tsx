...
export const Route = createFileRoute("/insights")({
  ...
  head: () =>
    // Personal insights view — auth-walled, should never be indexed.
    buildHead({
      title: "Continuum — Insights",
      description:
        "View your habit streaks, completion rates, and 30-day history.",
      path: "/insights",
      noindex: true,
    }),
});
      ...
      <div className="max-w-lg mx-auto px-5 pt-12">
        ...
        {habits.length === 0 ? (
          ...
          <div className="mt-6 space-y-5">
            ...
            {habits.map((habit, i) => {
              // Pass the full habits array so weekday-frequency streaks correctly
              // skip non-scheduled days (otherwise a Mon/Wed/Fri habit logged on
              // Mon and Wed reports streak=1 instead of 2).
