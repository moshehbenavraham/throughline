...
export const Route = createFileRoute("/login")({
  ...
  head: () =>
    buildHead({
      ...
      description:
        "Sign in or create a free Continuum account to sync your habits, streaks, and progress across devices.",
      path: "/login",
    }),
});
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-5 relative bg-white">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${shadowBg})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', opacity: 0.75 }}
      />
      ...
      <div className="max-w-sm w-full animate-fade-up-blur relative z-10">
        ...
        <Link
          ...
          className="flex items-center justify-center gap-2.5 mb-8 hover:opacity-80 transition-opacity rounded-md outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        >
          <InfinityIcon className="w-7 h-7 text-foreground" strokeWidth={2.5} aria-hidden="true" />
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-xl border border-input bg-background py-3.5 text-sm font-medium text-foreground hover:bg-accent transition-all duration-200 active:scale-[0.98] disabled:opacity-40 disabled:pointer-events-none outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        >
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground rounded outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-[#FDAA3E] text-[#1a1a1a] py-3.5 text-sm font-bold hover:bg-[#fdb95e] transition-all duration-200 active:scale-[0.98] disabled:opacity-40 disabled:pointer-events-none shadow-lg shadow-[#FDAA3E]/20 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <button
            ...
            className="text-primary font-medium hover:underline rounded outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
